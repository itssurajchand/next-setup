...
const Navigation = (props: Props) => {
    ...
    const [unapprovedPage, setIsUnapprovedPage] = useState(false);
    ...
    useEffect(() => {
        const unapprovedPage = (utils.dom.isWindowPresent() ? window.location.pathname : "/") === "/unapproved"
        setIsUnapprovedPage(unapprovedPage);
    }, [])
